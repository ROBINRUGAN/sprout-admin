...
const intros = ref<Intro[]>([
  {
    img: '../src/assets/official/game.png',
    title: '游戏化任务',
    content: '创新的游戏化设计\n提升用户体验'
  },
  {
    img: '../src/assets/official/AI.png',
    title: 'AI识别',
    content: '支持人脸识别、姿态识别、物品识别等AI识别功能'
  },
  {
    img: '../src/assets/official/earn.png',
    title: '多元盈利',
    content: '多元化盈利模式\n具有商业可持续性'
  },
  {
    img: '../src/assets/official/fullsvc.png',
    title: '全面服务',
    content:
      '支持查询学校信息、报修设备、在活动评论区交流、查询个人成绩排名、参考选课意见等全面校园服务'
  },
  {
    img: '../src/assets/official/vsbdata.png',
    title: '可视化数据',
    content: '管理端提供日活、广告、学生注册地区、学生学院等信息的可视化查询功能'
  },
  {
    img: '../src/assets/official/managable.png',
    title: '支持管理',
